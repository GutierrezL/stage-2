...
public class MenuItemTest {
	...
	public void testEqualsObject() {
		...
		MenuItem t1 = new MenuItem("carrots", 2.50, "Side", true);
		MenuItem t2 = new MenuItem("carrots", 2.50, "Side", true);
		MenuItem t3 = new MenuItem("carrots", 2.50, "Main", true);
		MenuItem t4 = new MenuItem("carrots", 2.50, "Side", false);
		MenuItem t5 = new MenuItem("peas", 2.50, "Side", true);
		MenuItem t6 = new MenuItem("mash", 3.50, "Side", true);
	...
	public void testCompareByNameTo() {
		//Multiple instances of MenuItem class for testing
		MenuItem t1 = new MenuItem("carrots", 2.50, "Side", true);
		MenuItem t2 = new MenuItem("cabbage", 2.50, "Side", true);
		MenuItem t3 = new MenuItem("peas", 2.50, "Side", true);
		MenuItem t4 = new MenuItem("mash", 3.50, "Side", true);
	...
	public void testIsVegetarianPrint() {
		//Multiple instances of MenuItem class for testing
		MenuItem t1 = new MenuItem("carrots", 2.50, "Side", true);
		MenuItem t2 = new MenuItem("pasta", 5.50, "Main", false);
